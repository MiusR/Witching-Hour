...
execute as @e[type=armor_stand,tag=cauldron,tag=rgcatalist,tag=done] at @s run scoreboard players set @e[tag=magicaltar,distance=..20,scores={Power=500..},limit=1] mb_PowerCost 500
