...
execute as @e[type=armor_stand,tag=cauldron,tag=rdvpotion,tag=done] at @s run scoreboard players set @e[tag=magicaltar,distance=..20,scores={Power=15..},limit=1] mb_PowerCost 15
