execute as @p[tag=soulotp,nbt={SelectedItem:{tag:{mirror:1b}}},scores={Rclick=1..,Sneak=0,PlayerInfP=100..}] run tag @s add warpi
...
execute as @p[tag=soulotp,nbt={SelectedItem:{tag:{mirror:1b}}},scores={Rclick=1..,Sneak=0,PlayerInfP=100..}] run tag @s add lockedwarp
execute as @p[tag=soulotp,nbt={SelectedItem:{tag:{mirror:1b}}},scores={Rclick=1..,Sneak=0}] run scoreboard players set @s Rclick 0
...
execute as @p[tag=soulotp,nbt={SelectedItem:{tag:{mirror:1b}}},scores={Rclick=1..,Sneak=1..,PlayerInfP=500..}] run scoreboard players set @s Rclick 0
