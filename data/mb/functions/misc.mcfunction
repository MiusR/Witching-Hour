...
execute as @a[nbt=!{SelectedItem:{tag:{gchalk:1b}}},nbt=!{SelectedItem:{tag:{wchalk:1b}}},nbt=!{SelectedItem:{tag:{ichalk:1b}}},nbt=!{SelectedItem:{tag:{nediam:1b}}},nbt=!{SelectedItem:{tag:{mirror:1b}}},nbt=!{SelectedItem:{tag:{coinf:1b}}},nbt=!{SelectedItem:{tag:{crownm:1b}}}] run scoreboard players set @s Rclick 0
...
execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if entity @e[distance=..2,tag=taggedbed] store result entity @s Item.tag.taglockdata int 1 run scoreboard players get @e[tag=taggedbed,distance=..2,limit=1] Taglock
execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if entity @e[distance=..2,tag=taggedbed] run data merge entity @s {Item:{tag:{CustomModelData:18}}}
execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if entity @e[distance=..2,tag=taggedbed] run particle minecraft:dust 1 0 0 1 ~ ~ ~ 0 0 0 0 20
execute as @e[tag=taggedbed] at @s if entity @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] run kill @s
...
execute as @p[nbt={SelectedItem:{tag:{taglock:1b}}},nbt=!{SelectedItem:{tag:{taglockdata:0}}}] unless entity @a[distance=0.5..,tag=checktaglocktemp] run tag @s add checktaglocktemp
...
execute as @a[nbt={SelectedItem:{tag:{taglock:1b}}},scores={Sneak=1}] run tag @s add told
execute as @a[nbt=!{SelectedItem:{tag:{taglock:1b}}}] run tag @s remove told

execute as @p[nbt={SelectedItem:{tag:{bloodpact:1b}}},nbt=!{SelectedItem:{tag:{taglockdata:0}}}] unless entity @a[distance=0.5..,tag=checktaglocktemp1] run tag @s add checktaglocktemp1
...
execute as @a[nbt={SelectedItem:{tag:{bloodpact:1b}}},scores={Sneak=1}] run tag @s add told1
execute as @a[nbt=!{SelectedItem:{tag:{bloodpact:1b}}}] run tag @s remove told1

execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if block ~ ~-0.2 ~ minecraft:lectern[has_book=true] run summon item ~ ~ ~ {Item:{id:"minecraft:paper",Count:1b,tag:{display:{Name:"{\"text\":\"Blood Pact\",\"color\":\"green\"}"},CustomModelData:1,bloodpact:1b,taglockdata:0}}}
execute as @e[type=item,tag=!init,nbt={Item:{tag:{bloodpact:1b,taglockdata:0}}}] at @s store result entity @s Item.tag.taglockdata int 1 run data get entity @e[limit=1,type=item,nbt={Item:{tag:{taglock:1b}}},distance=..1] Item.tag.taglockdata 1
execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if block ~ ~-0.2 ~ minecraft:lectern[has_book=true,facing=east] run setblock ~ ~-0.2 ~ minecraft:lectern[has_book=false,facing=east]
execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if block ~ ~-0.2 ~ minecraft:lectern[has_book=true,facing=west] run setblock ~ ~-0.2 ~ minecraft:lectern[has_book=false,facing=west]
execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if block ~ ~-0.2 ~ minecraft:lectern[has_book=true,facing=north] run setblock ~ ~-0.2 ~ minecraft:lectern[has_book=false,facing=north]
execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if block ~ ~-0.2 ~ minecraft:lectern[has_book=true,facing=south] run setblock ~ ~-0.2 ~ minecraft:lectern[has_book=false,facing=south]
execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if block ~ ~-0.2 ~ minecraft:lectern[has_book=false] if entity @e[type=item,nbt={Item:{tag:{bloodpact:1b}}}] run playsound minecraft:block.lava.extinguish master @a[distance=..15] ~ ~ ~ 100 1
execute as @e[type=item,nbt={Item:{tag:{taglock:1b}},OnGround:1b}] at @s if block ~ ~-0.2 ~ minecraft:lectern[has_book=false] if entity @e[type=item,nbt={Item:{tag:{bloodpact:1b}}}] run particle minecraft:cloud ~ ~ ~ 0 0 0 0.1 10
execute as @e[type=item,tag=!init,nbt={Item:{tag:{bloodpact:1b}}}] at @s run kill @e[type=item,distance=..1,limit=1,nbt={Item:{tag:{taglock:1b}}}]