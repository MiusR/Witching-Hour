...
execute as @e[sort=random,type=enderman,tag=!found,limit=1] at @s in overworld if score scounter count matches 6 if block ~ ~-1 ~ grass_block run tag @s add c_faetree
