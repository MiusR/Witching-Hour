...
execute as @e[type=armor_stand,tag=cauldron,tag=!timer] at @s if entity @e[type=item,nbt={Item:{tag:{id:"bottled_pain"}}},distance=..1] if entity @e[type=item,distance=..1,nbt={Item:{tag:{id:"tounge_of_dog"}}}] if entity @e[type=item,distance=..1,nbt={Item:{tag:{id:"evil_blood"}}}] if entity @e[type=item,distance=..1,nbt={Item:{tag:{id:"eternal_hunger"}}}] if block ~ ~ ~ cauldron[level=3] if entity @e[tag=magicaltar,distance=..20,scores={Power=15..},limit=1] if block ~ ~-1 ~ fire run tag @s add rboleech
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=rboleech] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:splash_potion",Count:3b,tag:{CustomModelData:14,id:"brew_of_the_leech",display:{Name:"{\"text\":\"Brew of the Leech\",\"color\":\"green\"}"},HideFlags:63,CustomPotionColor:16233471}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=rboinfection] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:splash_potion",Count:3b,tag:{CustomModelData:15,id:"brew_of_infection",display:{Name:"{\"text\":\"Brew of Infection\",\"color\":\"green\"}"},HideFlags:63,CustomPotionColor:0}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=rbomistery] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:splash_potion",Count:3b,tag:{CustomModelData:16,id:"brew_of_mystery",display:{Name:"{\"text\":\"Brew of Mistery\",\"color\":\"green\"}"},HideFlags:63,CustomPotionColor:10444543}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=rqurtzsphere] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:glowstone_dust",Count:1b,tag:{display:{Name:"{\"text\":\"Quartz Ball\",\"color\":\"green\"}"},HideFlags:63,CustomModelData:122,id:"quartz_ball"}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=rredstonesoup] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:"{\"text\":\"Redstone Soup\",\"color\":\"green\"}"},CustomModelData:1,HideFlags:63,id:"redstone_soup",CustomPotionEffects:[{Id:1b,Amplifier:3b,Duration:5000},{Id:3b,Amplifier:3b,Duration:5000},{Id:5b,Amplifier:3b,Duration:5000},{Id:8b,Amplifier:3b,Duration:5000},{Id:10b,Amplifier:1b,Duration:5000},{Id:22b,Amplifier:2b,Duration:5000}],CustomPotionColor:16711680}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=rmysticointment] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:"{\"text\":\"Mystic Ointment\",\"color\":\"green\"}"},CustomModelData:2,HideFlags:63,id:"mystic_oinment",CustomPotionEffects:[{Id:9b,Amplifier:3b,Duration:800}],CustomPotionColor:1944924}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=rdvpotion] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:glass_bottle",Count:2b,tag:{CustomModelData:15,id:"diamond_vapor",display:{Name:"{\"text\":\"Diamond Vapor\",\"color\":\"green\"}"}}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=rtgk] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:glass_bottle",Count:1b,tag:{CustomModelData:17,id:"taglock_kit",taglockdata:0,display:{Name:"{\"text\":\"Taglock kit\",\"color\":\"green\"}"}}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=riotbe] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:"{\"text\":\"Blind Eye Infusion\",\"color\":\"green\"}"},HideFlags:63,CustomModelData:3,id:"blind_eye_infusion",CustomPotionEffects:[{Id:4b,Amplifier:2b,Duration:200},{Id:15b,Amplifier:1b,Duration:200},{Id:17b,Amplifier:3b,Duration:200},{Id:27b,Amplifier:2b,Duration:200}],CustomPotionColor:7368816}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=riof] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:"{\"text\":\"Infusion of Fortune\",\"color\":\"green\"}"},HideFlags:63,CustomModelData:5,id:"infusion_of_fortune",CustomPotionEffects:[{Id:26b,Amplifier:1b,Duration:1000}],CustomPotionColor:7368816}}}
...
execute as @e[type=armor_stand,tag=cauldron,tag=timer,tag=done,tag=riol] at @s run summon item ~ ~0.5 ~ {NoGravity:1b,Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:"{\"text\":\"Soul of the World\",\"color\":\"green\"}"},HideFlags:63,CustomModelData:6,id:"soul_of_the_world",CustomPotionEffects:[{Id:11b,Amplifier:3b,Duration:5000}],CustomPotionColor:7368816}}}
