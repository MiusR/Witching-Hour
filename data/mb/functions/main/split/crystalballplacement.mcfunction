execute as @e[type=firework_rocket,nbt={FireworksItem:{tag:{id:"magic_ball"}}}] at @s unless entity @e[tag=magicball,distance=..0.5] run summon leash_knot ~ ~ ~ {Tags:["mcboftc"]}
execute as @e[type=firework_rocket,nbt={FireworksItem:{tag:{id:"magic_ball"}}}] at @s if entity @e[tag=magicball,distance=..0.5] run loot spawn ~ ~ ~ loot mb:items/magic_ball
...
execute as @e[tag=magicball] at @s unless block ~ ~ ~ air run loot spawn ~ ~ ~ loot mb:items/magic_ball
execute as @e[tag=magicball] at @s unless block ~ ~ ~ air run kill @s
execute as @e[tag=magicball] at @s if entity @e[tag=braziure,distance=..1] run loot spawn ~ ~ ~ loot mb:items/magic_ball
execute as @e[tag=magicball] at @s if entity @e[tag=braziure,distance=..1] run kill @s