execute as @e[type=firework_rocket,nbt={FireworksItem:{tag:{id:"brazier"}}}] at @s unless entity @e[tag=brazier,distance=..1] run summon leash_knot ~ ~ ~ {Tags:["brazierc"]}
execute as @e[type=firework_rocket,nbt={FireworksItem:{tag:{id:"brazier"}}}] at @s if entity @e[tag=brazier,distance=..1] run loot spawn ~ ~ ~ loot mb:items/brazier
...
execute as @e[tag=brazier] at @s unless block ~ ~ ~ air run loot spawn ~ ~ ~ loot mb:items/brazier
execute as @e[tag=brazier] at @s unless block ~ ~ ~ air run kill @s
execute as @e[tag=brazier] at @s if entity @e[tag=magicball,distance=..1] run loot spawn ~ ~ ~ loot mb:items/brazier
execute as @e[tag=brazier] at @s if entity @e[tag=magicball,distance=..1] run kill @s