...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofrain] run function mb:rituals/ritual-rain
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofnight] run function mb:rituals/ritual-night
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofthethunderstorm] run function mb:rituals/ritual-thunder

execute as @e[tag=!rtimer,tag=!rctimer,tag=cmgc,nbt={ActiveEffects:[{Id:26b,Amplifier:-1b}]}] at @s if entity @e[tag=magicaltar,distance=..20,scores={Power=290..}] if entity @e[type=item,distance=..3,nbt={Item:{id:"minecraft:obsidian",Count:1b}}] if entity @e[type=item,distance=..3,nbt={Item:{id:"minecraft:slime_ball",Count:1b}}] run function mb:rituals/ritual-eventhorizon
...
execute as @e[tag=!rtimer,tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]}] at @s if entity @e[tag=magicaltar,distance=..20,scores={Power=290..}] if entity @e[type=item,distance=..3,nbt={Item:{tag:{id:"greater_catalist"}}}] if entity @e[type=item,distance=..3,nbt={Item:{id:"minecraft:gunpowder",Count:1b}}] if entity @e[type=item,distance=..3,nbt={Item:{id:"minecraft:redstone",Count:1b}}] run function mb:rituals/ritual-charging
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofcharging] run function mb:rituals/ritual-charging
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:12b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofsummoningdemon] run function mb:rituals/ritual-summoning-demon
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:26b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualoftheblade] run function mb:rituals/ritual-sword
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:17b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofthetrader] run function mb:rituals/ritual-summoning-wanderer
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofuplisting] run function mb:rituals/ritual-uplift1
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:5b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofuplisting1] run function mb:rituals/ritual-uplift2
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:26b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofuplisting2] run function mb:rituals/ritual-uplift3
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:5b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualoft] run function mb:rituals/ritual-future

execute as @e[tag=!rtimer,tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]}] at @s if entity @e[tag=magicaltar,distance=..20,scores={Power=400..}] if entity @e[type=item,distance=..3,nbt={Item:{id:"minecraft:skeleton_skull",Count:1b}}] if entity @e[type=item,distance=..3,nbt={Item:{id:"minecraft:stone",Count:1b}}] if entity @e[type=item,distance=..3,nbt={Item:{tag:{id:"charged_greater_caralist"}}}] if score traker Time matches 12900..22900 run function mb:rituals/ritual-necromancy
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofnecromancy] if score traker Time matches 12900..22900 run function mb:rituals/ritual-necromancy

execute as @e[tag=!rtimer,tag=cmgc,nbt={ActiveEffects:[{Id:15b,Amplifier:-1b}]}] at @s if entity @e[tag=magicaltar,distance=..20,scores={Power=400..}] if entity @e[type=item,distance=..3,nbt={Item:{id:"minecraft:diamond",Count:1b}}] if entity @e[type=item,distance=..3,nbt={Item:{id:"minecraft:nether_star",Count:1b}}] if entity @e[type=item,distance=..3,nbt={Item:{tag:{id:"greater_catalist"}}}] if entity @e[type=item,distance=..3,nbt={Item:{tag:{id:"spectral_dust"}}}] if score traker Time matches 12900..22900 run function mb:rituals/ritual-soulgem
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:15b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofnecros] if score traker Time matches 12900..22900 run function mb:rituals/ritual-soulgem
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:26b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofinfusionI] run function mb:rituals/ritual-infusion1
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:26b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofinfusionII] run function mb:rituals/ritual-infusion3
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofthrplanes] run function mb:rituals/ritual-hand-mirror
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:26b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofinfusionIII] run function mb:rituals/ritual-infusion4
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualoffate] run function mb:rituals/ritual-coins
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:26b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofinfusionIV] run function mb:rituals/ritual-infusion2
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualoftheking] run function mb:rituals/ritual-mosscrown
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:17b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualoftheking] run function mb:rituals/ritual-heavycattle
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:5b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofthebroom] run function mb:rituals/ritual-broom-infusion
...
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:1b,Amplifier:-1b}]},scores={Timer=29..},tag=ritualofthegate] run function mb:rituals/ritual-the-gate

execute as @e[tag=!rtimer,tag=cmgc,nbt={ActiveEffects:[{Id:17b,Amplifier:-1b}]}] at @s if entity @e[tag=magicaltar,distance=..20,scores={Power=600..}] if entity @e[type=item,distance=..3,nbt={Item:{tag:{id:"condensed_fear"}}}] if entity @e[type=item,distance=..3,nbt={Item:{tag:{id:"wool_of_bat"}}}] run function mb:rituals/ritual-curse-blight
execute as @e[tag=cmgc,nbt={ActiveEffects:[{Id:17b,Amplifier:-1b}]},scores={Timer=29..},tag=curseofblight] run function mb:rituals/ritual-curse-blight