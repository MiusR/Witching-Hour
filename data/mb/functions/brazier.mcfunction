...
execute as @e[type=item,nbt={Item:{tag:{brazier:1b}},OnGround:1b}] at @s run summon leash_knot ~ ~ ~ {Tags:["brazierc"]}
...
execute as @e[type=item,nbt={Item:{tag:{brazier:1b}},OnGround:1b}] at @s run kill @s
execute as @e[tag=brazierc] at @s run kill @s
execute as @e[tag=brazier] at @s if block ~ ~-1 ~ air run summon item ~ ~ ~ {NoGravity:1b,Item:{id:"minecraft:glowstone_dust",Count:1b,tag:{display:{Name:"{\"text\":\"Brazier\",\"color\":\"green\"}"},CustomModelData:125,brazier:1b}}}
...
execute as @e[tag=brazier,tag=!spectral_dust,tag=!ignited] at @s if entity @e[type=item,distance=..1,nbt={Item:{tag:{specdust:1b}}}] run tag @s add spectral_dust
execute as @e[tag=brazier,tag=spectral_dust,tag=!hasitems,tag=!ignited] at @s run tag @s add hasitems
execute as @e[tag=brazier,tag=spectral_dust,tag=!ignited] at @s if entity @e[type=item,distance=..1,nbt={Item:{tag:{specdust:1b}}}] run kill @e[type=item,distance=..1]

execute as @e[tag=brazier,tag=!luck,tag=!ignited] at @s if entity @e[type=item,distance=..1,nbt={Item:{tag:{lqpotion:1b}}}] run tag @s add luck
execute as @e[tag=brazier,tag=luck,tag=!hasitems,tag=!ignited] at @s run tag @s add hasitems
execute as @e[tag=brazier,tag=luck,tag=!ignited] at @s if entity @e[type=item,distance=..1,nbt={Item:{tag:{lqpotion:1b}}}] run kill @e[type=item,distance=..1]
...
execute as @e[tag=brazier,tag=bssf,scores={braziertimer=0}] at @s run summon chicken ~ ~ ~ {Team:"UF",PersistenceRequired:1b,IsChickenJockey:0b,Motion:[0.0,1.0,0.0],Tags:["inv","joinUF"],ArmorItems:[{},{},{},{id:"minecraft:glowstone_dust",Count:1b,tag:{display:{Name:"{\"text\":\"Spectral Dust\",\"color\":\"green\"}"},CustomModelData:127,specdust:1b}}],ArmorDropChances:[0.85F,0.85F,0.85F,0.6F]}
...
execute as @e[tag=brazier,tag=bsbanshee,scores={braziertimer=0}] at @s run summon zombie ~ ~ ~ {Silent:1b,DeathLootTable:"345678",IsBaby:0b,Tags:["banshee","inv","slowf"],ArmorItems:[{},{},{id:"minecraft:glass_bottle",Count:1b,tag:{display:{Name:"{\"text\":\"Condensed Fear\",\"color\":\"green\"}"},CustomModelData:16,condfpotion:1b}},{id:"minecraft:glowstone_dust",Count:1b,tag:{CustomModelData:128}}],ArmorDropChances:[0.85F,0.85F,0.5F,-327.67F],Attributes:[{Name:generic.movementSpeed,Base:0.001},{Name:generic.attackDamage,Base:0}]}
...
execute as @e[tag=banshee] at @s if entity @p[distance=..10] run data merge entity @s {ArmorItems:[{},{},{id:"minecraft:glass_bottle",Count:1b,tag:{display:{Name:"{\"text\":\"Condensed Fear\",\"color\":\"green\"}"},CustomModelData:16,condfpotion:1b}},{id:"minecraft:glowstone_dust",Count:1b,tag:{CustomModelData:129}}],ArmorDropChances:[0.85F,0.85F,0.5F,-327.67F]}
execute as @e[tag=banshee] at @s unless entity @p[distance=..10] run data merge entity @s {ArmorItems:[{},{},{id:"minecraft:glass_bottle",Count:1b,tag:{display:{Name:"{\"text\":\"Condensed Fear\",\"color\":\"green\"}"},CustomModelData:16,condfpotion:1b}},{id:"minecraft:glowstone_dust",Count:1b,tag:{CustomModelData:128}}],ArmorDropChances:[0.85F,0.85F,0.5F,-327.67F]}
...
execute as @e[tag=brazier,tag=bssd,scores={braziertimer=0}] at @s run summon iron_golem ~ ~ ~ {Team:"UF",PersistenceRequired:1b,Tags:["inv","joinUF"],ArmorItems:[{},{},{},{id:"minecraft:glowstone_dust",Count:1b,tag:{display:{Name:"{\"text\":\"Spectral Dust\",\"color\":\"green\"}"},CustomModelData:127,specdust:1b}}],ArmorDropChances:[0.85F,0.85F,0.85F,0.6F]}
...
execute as @e[tag=undeadh,tag=text] at @s if entity @e[type=item,distance=..3,nbt={Item:{tag:{bloodpact:1b}}}] store result score @s Taglocktemp run data get entity @e[type=item,distance=..3,nbt={Item:{tag:{bloodpact:1b}}},limit=1] Item.tag.taglockdata 1
execute as @e[tag=undeadh,tag=text] at @s if entity @e[type=item,distance=..3,nbt={Item:{tag:{bloodpact:1b}}}] unless score @s Taglocktemp = @a[limit=1] Taglock run tellraw @a[distance=..15] {"text":"<Undead Hunter> I can't find something that doesn't exist!","color":"red","hoverEvent":{"action":"show_text","value":"Player offline! :("}}
execute as @e[tag=undeadh,tag=text] at @s if entity @e[type=item,distance=..3,nbt={Item:{tag:{bloodpact:1b}}}] if score @s Taglocktemp = @a[limit=1] Taglock run tellraw @a[distance=..15] {"text":"<Undead Hunter> Your wish is my command!","color":"red","hoverEvent":{"action":"show_text","value":"Done!"}}
...
execute as @e[tag=undeadh,tag=text] at @s if entity @e[type=item,distance=..3,nbt={Item:{tag:{bloodpact:1b}}}] run tag @s add done
