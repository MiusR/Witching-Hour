...
execute as @e[tag=borasisingf] at @s unless entity @e[tag=borasising,distance=..1] run summon zombie ~ ~ ~ {Team:"UF",HandItems:[{},{id:"minecraft:stone_axe",Count:1b}],Tags:["summoned","joinUF"]}
