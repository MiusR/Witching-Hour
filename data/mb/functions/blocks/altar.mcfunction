...
execute as @e[tag=magicaltar] at @s if block ~ ~1 ~ air if block ~ ~-1 ~ air if block ~ ~ ~ air run kill @e[limit=3,tag=altar_spirit,distance=..20]
...
execute as @e[tag=magicaltar,tag=stage2,tag=!activated,scores={PTD=10}] at @s unless entity @p[distance=..10,nbt={SelectedItem:{id:"minecraft:emerald"}}] unless entity @e[type=item,distance=..1,nbt={Item:{id:"minecraft:emerald",Count:1b}}] run setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"tree_altar",posX:-2,posY:0,posZ:-2,rotation:"NONE",mirror:"NONE",mode:"LOAD",ignoreEntities:1b}
execute as @e[tag=magicaltar,tag=stage2,tag=!activated,scores={PTD=10}] at @s unless entity @p[distance=..10,nbt={SelectedItem:{id:"minecraft:emerald"}}] unless entity @e[type=item,distance=..1,nbt={Item:{id:"minecraft:emerald",Count:1b}}] run setblock ~ ~-2 ~ minecraft:redstone_block
execute as @e[tag=magicaltar,tag=stage2,tag=!activated,scores={PTD=10}] at @s unless entity @p[distance=..10,nbt={SelectedItem:{id:"minecraft:emerald"}}] unless entity @e[type=item,distance=..1,nbt={Item:{id:"minecraft:emerald",Count:1b}}] run particle minecraft:composter ~ ~ ~ 1 1 1 0 10
execute as @e[tag=magicaltar,tag=stage2,tag=!activated,scores={PTD=10}] at @s unless entity @p[distance=..10,nbt={SelectedItem:{id:"minecraft:emerald"}}] unless entity @e[type=item,distance=..1,nbt={Item:{id:"minecraft:emerald",Count:1b}}] run playsound minecraft:entity.armor_stand.break master @a[distance=..20] ~ ~ ~ 10 1
