...
execute as @e[tag=brazier,tag=bsbanshee,scores={braziertimer=0}] at @s run summon zombie ~ ~ ~ {Silent:1b,DeathLootTable:"345678",IsBaby:0b,Tags:["banshee","inv","slowf"],ArmorItems:[{},{},{id:"minecraft:glass_bottle",Count:1b,tag:{display:{Name:"{\"text\":\"Condensed Fear\",\"color\":\"green\"}"},CustomModelData:16,id:"condensed_fear"}},{id:"minecraft:glowstone_dust",Count:1b,tag:{CustomModelData:128}}],ArmorDropChances:[0.85F,0.85F,0.5F,-327.67F],Attributes:[{Name:generic.movementSpeed,Base:0.001},{Name:generic.attackDamage,Base:0}]}
...
execute as @e[tag=banshee] at @s if entity @p[distance=..10] run data merge entity @s {ArmorItems:[{},{},{id:"minecraft:glass_bottle",Count:1b,tag:{display:{Name:"{\"text\":\"Condensed Fear\",\"color\":\"green\"}"},CustomModelData:16,id:"condensed_fear"}},{id:"minecraft:glowstone_dust",Count:1b,tag:{CustomModelData:129}}],ArmorDropChances:[0.85F,0.85F,0.5F,-327.67F]}
execute as @e[tag=banshee] at @s unless entity @p[distance=..10] run data merge entity @s {ArmorItems:[{},{},{id:"minecraft:glass_bottle",Count:1b,tag:{display:{Name:"{\"text\":\"Condensed Fear\",\"color\":\"green\"}"},CustomModelData:16,id:"condensed_fear"}},{id:"minecraft:glowstone_dust",Count:1b,tag:{CustomModelData:128}}],ArmorDropChances:[0.85F,0.85F,0.5F,-327.67F]}
