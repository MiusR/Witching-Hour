...
execute as @a[nbt={RootVehicle:{Entity:{Tags:["flying_broom"]}}}] at @s as @e[sort=nearest,limit=1,tag=flying_broom] at @s if block ^ ^0.6 ^1 #mb:passable run tp @s ^ ^ ^1
